...
// ============================================================
const DETAIL_HEADERS = ['公司', '城市', '部门', '岗位', '工作制度', '周末类型', '上班时间', '下班时间', '一周工作天数', '规则', '证据', '来源平台', '来源链接', '可信度', '采集时间', '品牌/产品'];
const DETAIL_DATA: (string | number)[][] = [
  ['示例双休科技有限公司', '杭州', '研发中心', '后端工程师', '955', '双休', '09:30', '18:30', '5', '弹性工作不打卡', '官网招聘页注明双休', 'BOSS直聘', 'https://www.zhipin.com/job_detail/example1.html', 'B', '2026-06-27', '某双休App|某云服务'],
  ['示例大小周网络有限公司', '北京', '增长部', '前端工程师', '996', '大小周', '10:00', '21:00', '5.5', '大小周, 周六轮班', '职位页注明大小周', '51job', 'https://jobs.51job.com/example2.html', 'B', '2026-06-27', '某社交App'],
  ['示例单休制造有限公司', '东莞', '生产管理', '工艺工程师', '单休', '单休', '08:00', '18:00', '6', '单休, 月休4天', '招聘页明确单休', '智联招聘', 'https://www.zhaopin.com/example3.html', 'C', '2026-06-27', '某家电品牌|某五金工具'],
];
